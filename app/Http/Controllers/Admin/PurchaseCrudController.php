...
class PurchaseCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            'name' => 'memberID', // Field name in purchases table
            'label' => 'Member ID',
            'type' => 'select', // Use select2 for better UI
            'entity' => 'member', // Relationship method in model
            'attribute' => 'member_id_name', // Use accessor instead of 'name'
            'model' => "App\Models\Member", // Related model
            'options' => function ($query) {
                return $query->select('memberID', 'name')->orderBy('memberID', 'ASC')->get();
            },
        ]);
